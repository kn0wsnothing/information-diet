...
export default function StoryGraphConnectPage() {
  ...
  const handleImport = async () => {
    ...
    try {
      ...
      const response = await fetch("/app/api/import/storygraph", {
        method: "POST",
        body: formData,
      });
    ...
    <div className="min-h-screen bg-zinc-50">
      <div className="mx-auto max-w-xl px-6 py-12">
        ...
        <p className="mt-2 text-sm text-zinc-600">
          Import your reading list from StoryGraph to track your books in Information Diet.
        </p>

        <div className="mt-8 space-y-6">
          <div className="rounded-xl border border-zinc-200 bg-white p-6">
            <h2 className="text-lg font-medium text-zinc-900 mb-2">Export your StoryGraph data</h2>
            <ol className="text-sm text-zinc-600 space-y-2 list-decimal list-inside">
              <li>Go to <a href="https://app.thestorygraph.com/export" target="_blank" className="text-blue-600 underline">StoryGraph Export</a></li>
              <li>Download your CSV export</li>
